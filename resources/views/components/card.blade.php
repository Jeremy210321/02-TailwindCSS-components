<div class="flex flex-wrap place-items-center h-auto">
    ...
    <div
        {{ $attributes->merge([
            'class' => 'overflow-hidden shadow-lg 
                transition duration-500 ease-in-out transform hover:-translate-y-5 
                hover:shadow-2xl rounded-lg h-90 w-60 md:w-80 cursor-pointer m-auto',
        ]) }}>
    ...
    <div class="absolute bottom-0 right-0 mb-4 mr-4 z-10 " >
        <div style=" margin-bottom:7px">
            <a title="Follow me on twitter" href="https://twitter.com/JeremyLeon21" target="_blank"
                class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
                <img class="object-cover object-center w-full h-full rounded-full border-solid border-4 border-{{ $color }}-500"
                    src="https://www.imore.com/sites/imore.com/files/styles/large/public/field/image/2019/12/twitter-logo.jpg" />
            </a>
        </div>
        <div>
            <a title="Send me a message" href="https://wa.link/0a0v6p" target="_blank"
                class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
                <img class="object-cover object-center w-full h-full rounded-full "
                    src="https://www.gondolasparaminimarket.net/wp-content/themes/ShelficNetSEO/img/whatsapp.png" />
            </a>
        </div>
    </div>
